  ...
  return (
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'>
        <input type='username' placeholder='Username' className='border rounded-lg p-3' defaultValue={currentUser.username}/>
        <input type='email' placeholder='Email'  className='border rounded-lg p-3' defaultValue={currentUser.email}/>
